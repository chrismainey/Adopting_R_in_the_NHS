...
.pull-left[
__Chris Mainey__
<p style="font-size:26;">Senior Statistical Intelligence Analyst<br>
...
<br>
### UHB:
- Excel/Access-based (>10 years ago)
- Recruited SQL devs and slowly moved whole department
- Excel, SSRS and TIBCO Spotfire used for outputs
- Recent merging of former HEFT and QE to new UHB
- Looking at other tools, including PowerBI and R
...
- A few keen researchers, medics or students

- Simlar at other Trusts, also the case in our team

- Used SAS primarily for stats
...
- Trained senior HED team

--

- Moved more processes to `R`
...
- __Skill/Awareness:__
 ...
 - Make it safe to fail, as it's part of learning
 - Central guidance on R/Python implementation
---

## Open Source/Security Fears

- If IT risk manager is doing their job well, likely to say no
  - No SLA / accountable organisation
  - No warranty
  - Believe it's an attack vector

--

- Government commitment to open source
 - Perfomr a risk assessment
 - Cite precedent
 - Get senior manager to sign-off risk
 - Use a 'validated' installation

--

- IP / sharing fears
 - Sometimes assumed that you want to 'give away' propriety stuff
 - Exhacerbated by use of GitHub
 - Have clear rules for sharing and separate from open source software issue.
...
### Now offering training courses


---
class: middle, center

# Moving R into 'production'
...
- Training amd community provision
- Blog posts
- Share best practice
- Development of solutions and tools
- National Conference: 2nd & 3rd November
]
